...
export const getStandardApplicationDescription =
  (): string => t`The base data model every Octave CRM AI workspace runs on.

#### What "foundation" means

Every Octave CRM AI workspace starts with this set of objects. They define the shape of your CRM, including relationships, activity, and reporting. Everything else, including marketplace apps, AI agents, and custom objects, plugs into them.
...
Remove this app and the rest of Octave CRM AI has nothing to hang off.
