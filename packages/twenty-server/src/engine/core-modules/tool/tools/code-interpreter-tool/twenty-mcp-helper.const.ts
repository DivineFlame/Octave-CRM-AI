...
export const TWENTY_MCP_HELPER = `# Auto-injected Octave CRM AI MCP helper - provides access to Octave CRM AI tools
import os
import json
...
class TwentyMCP:
    """Helper for calling Octave CRM AI tools from sandboxed code.
    ...
    def call_tool(self, name: str, arguments: dict = None):
        """
        Call any Octave CRM AI tool by name.
        ...
        if not self._available:
            raise RuntimeError('Octave CRM AI MCP bridge not available. Missing requests library or credentials.')
