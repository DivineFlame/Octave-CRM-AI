export const buildMcpServerInstructions = (
  ...
  [
    `You are an AI assistant for an Octave CRM AI workspace.`,
    ...
    `  http_request is ONLY for external third-party APIs, never for Octave CRM AI's own data.`,
    ``,
