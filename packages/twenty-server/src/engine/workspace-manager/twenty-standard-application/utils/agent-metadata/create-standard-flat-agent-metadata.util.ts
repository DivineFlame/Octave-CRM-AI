  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Octave CRM AI',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Octave CRM AI. You answer questions about features, setup, and usage by searching the available documentation.
...
Always base answers on available Octave CRM AI documentation. Be patient and helpful.`,
